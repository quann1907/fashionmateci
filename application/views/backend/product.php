                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($product as $value): ?>
                                                <tr>
                                                    ...
                                                    <?php } else { ?>
                                                        <td><span class="badge light badge-warning">Lỗi</span></td>
                                                    <?php }?>
                                                    <td><?= $value['note'] ?></td>
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item btn <?= ($value['status']==1)?'disabled':'';?>" href="<?= base_url()?>admin/Product/changeStatus/<?= $value['id'] ?>/1">Kích hoạt động</a>
                                                                <a class="dropdown-item btn <?= ($value['status']==0)?'disabled':'';?>" href="<?= base_url()?>admin/Product/changeStatus/<?= $value['id'] ?>/0">Ngừng kinh doanh</a>
                                                                <a class="dropdown-item btn" href="<?= base_url() ?>admin/Product/loadEditProduct/<?= $value['id'] ?>">Cập nhật dữ liệu sản phẩm</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
