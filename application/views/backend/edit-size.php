...
<head>
	...
	<title>Cập nhật dữ liệu kích cỡ</title>
	<!-- Favicon icon -->
					...
					<div class="col-xl-12 col-xxl-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Cập nhật dữ liệu kích cỡ</h4>
							</div>
							<div class="card-body">
								<?php foreach ($size as $value): ?>
								<form action="<?= base_url() ?>admin/Size/editSize/<?= $value['id'] ?>" method="POST" enctype="multipart/form-data">
									<div>
										<div class="col-lg-12 mb-2">
											<div class="form-group">
												<label class="text-label"><strong>Kích cỡ*</strong></label>
